...
map.getView().fit([1014993.356673, 6278420.977522, 1084048.528327, 6323451.373177], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lebensmittelnahversorgung</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (75 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Bewertung der Lebensmittelnahversorgung in den Gemeinde der Region Homberg.';
            }
